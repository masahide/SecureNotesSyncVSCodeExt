...
- **🏗️ Dependency Injection**: Modern DI container for testable and maintainable code
- **📋 Index History**: View and navigate through historical index states
...
- GEMINI.md → “Extension Architecture” and “Dependency Injection Best Practices”
- GEMINI.md → “Encryption Strategy”, “Version Control Model”, and “File Organization”
- GEMINI.md → “Configuration Management” and “Configuration Schema”
- GEMINI.md → “Code Style & Patterns” and “Error Handling Patterns”
- GEMINI.md → “Storage Conventions”
- GEMINI.md → “Testing Guidelines” and “Testing Best Practices”

## Configuration and Commands

See GEMINI.md for the authoritative “Configuration Schema” and “Commands” sections.

## Testing

For structure, mocks, and best practices, see GEMINI.md → “Testing Guidelines”, “Testing Best Practices”.
Local commands remain:
```bash
npm run test        # VS Code tests
npm run test:unit   # TS-only tests via tsx
npm run test:fast   # Unit + lint
```
...
See GEMINI.md → “Security Considerations” for encryption, key handling, and Git guidance.
...
- Testing: Prefer fast unit tests via `npm run test:unit`; use VS Code tests for integration. Mock Git and 1Password, use temp dirs, and keep tests deterministic.
